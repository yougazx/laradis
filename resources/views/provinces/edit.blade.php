                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ $updateLink }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" id="input-name" placeholder="Enter name" value="{{ old('name', $province->name) }}" required autofocus>
