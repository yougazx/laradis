                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ $storeLink }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="total_population" class="form-control {{ $errors->has('total_population') ? ' is-invalid' : '' }}" id="input-total_population" placeholder="Masukkan total populasi" value="{{ old('total_population') }}" required autofocus>
